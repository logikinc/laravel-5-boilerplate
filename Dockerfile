...
##   $ docker build -t logikinc-laravel-5-boilerplate .
##
## RUNNING
##   $ docker run -p 9000:9000 logikinc-laravel-5-boilerplate
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="0omhsas" \
    STACKSMITH_STACK_NAME="logikinc/laravel-5-boilerplate" \
